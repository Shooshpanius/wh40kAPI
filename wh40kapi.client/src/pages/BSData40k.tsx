    ...
    if (error || catalogues.length === 0) {
        return (
            <div style={styles.container}>
                ...
                <p style={styles.desc}>
                    Данные Warhammer 40,000 из репозитория{' '}
                ...
                <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
                    ...
                    <a href="/scalar/bsdata" target="_blank" rel="noopener noreferrer" style={styles.buttonLink}>📖 API Docs</a>
                </div>
            </div>
        );
    }
    ...
    return (
        <div style={styles.page}>
            <div style={styles.header}>
                <h2 style={styles.title}>API BSData 40k</h2>
